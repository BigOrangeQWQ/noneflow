...
async def test_validate_info_from_issue_adapter(
    ...
    from src.plugins.publish.validation import validate_adapter_info_from_issue
...
async def test_validate_info_from_issue_bot(
    ...
    from src.plugins.publish.validation import validate_bot_info_from_issue
...
async def test_validate_info_from_issue_plugin(
    ...
    from src.plugins.publish.validation import validate_plugin_info_from_issue
